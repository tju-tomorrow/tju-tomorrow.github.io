...
analogy:
If you look at this in a broad way you can see Promise keep emerge-dive this pattern I think the Promise-wrapper is the same just the inside-value(or result) changes each time emerge-dive
...
> [!NOTE]
>
> You don't get the infomation now
